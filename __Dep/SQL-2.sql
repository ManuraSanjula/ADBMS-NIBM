...
CREATE TABLE Admin (
    ...
    ContactEmail VARCHAR2(100) CHECK (ContactEmail LIKE '%@%.%'),
...
BEGIN
    Insert_Supplier(
        ...
        p_ContactEmail  => 'chanuth_dk@outlook.com',
...
BEGIN
    Insert_Customer(
        p_FirstName         => 'Manura',
        p_LastName          => 'Sanjula',
        p_Email             => 'manurasanjula@gmail.com',
        p_Phone             => '098-765-4321',
        p_Address           => '456 Main Street',
        p_City              => 'Bambalapitiya',
        p_State             => 'Colombo',
        p_ZipCode           => '67890',
    ...
    DBMS_OUTPUT.PUT_LINE('Inserted Customer: Manura Sanjula');
END;
/
...
-- BEGIN
--     Insert_Address(
--         p_CustomerID  => (SELECT CustomerID FROM Customer WHERE Email = 'manurasanjula@gmail.com'),
...
--         p_AddressType => 'Home'
--     );
--     DBMS_OUTPUT.PUT_LINE('Inserted Shipping Address for Manura Sanjula');
-- END;
-- /
...
BEGIN
    ...
    INTO v_CustomerID 
    FROM Customer 
    WHERE Email = 'manurasanjula@gmail.com';
...
BEGIN
    ...
    -- Output a confirmation message
    DBMS_OUTPUT.PUT_LINE('Inserted Billing Address for Manura Sanjula');
END;
/
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Inserted Order for Manura Sanjula');
EXCEPTION
    WHEN NO_DATA_FOUND THEN
...
BEGIN
    -- Retrieve CustomerID for Manura Sanjula
    SELECT CustomerID 
    INTO v_CustomerID 
    FROM Customer 
    WHERE Email = 'manurasanjula@gmail.com';
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Inserted Cart for Manura Sanjula');
EXCEPTION
    WHEN NO_DATA_FOUND THEN
        DBMS_OUTPUT.PUT_LINE('Customer not found.');
    WHEN TOO_MANY_ROWS THEN
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Updated Customer Phone Number for Manura Sanjula');
EXCEPTION
    WHEN NO_DATA_FOUND THEN
