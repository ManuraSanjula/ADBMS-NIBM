...
BEGIN
    ...
    INSERT INTO Admin (FirstName, LastName, UserID, ContactEmail)
    VALUES (p_first_name, p_last_name, v_user_id, p_email);
...
BEGIN
    ...
    INSERT INTO Driver (FirstName, LastName, UserID, LicenseNumber, ContactEmail)
    VALUES (p_first_name, p_last_name, v_user_id, p_license_number, p_email);
...
BEGIN
    ...
    INSERT INTO Manager (FirstName, LastName, UserID, ContactEmail) 
    VALUES (p_first_name, p_last_name, v_user_id, p_email);
...
BEGIN
    add_supplier(
        ...
        p_contact_email    => 'john.doe@abcsupplies.com',
        p_phone            => '123-456-7890',
...
BEGIN
    add_admin('Hansana', 'Adhikari', 'hansana@gmail.com', 'hansana2001', 'password123', '123456789V');
END;
/
...
BEGIN
    add_manager('mathesha', 'Silva', 'matheesha@gmial.com', 'matheesha1234','password123', '456789123V');
END;
/
